...
export function CourtsList() {
  ...
  const courts: Court[] = [{
    id: "1",
    name: "Kohima Sports Complex",
    location: "Near Secretariat, Kohima",
    price: 30000,
    memberPrice: 20000,
    image: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    isIndoor: true,
    city: "Kohima",
    available: true
  }, {
    id: "2",
    name: "Dimapur Indoor Courts",
    location: "City Tower, Dimapur",
    price: 25000,
    memberPrice: 15000,
    image: "https://images.unsplash.com/photo-1534158914592-062992fbe900?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    isIndoor: true,
    city: "Dimapur",
    available: true
  }, {
    id: "3",
    name: "Mokokchung Community Center",
    location: "Town Square, Mokokchung",
    price: 20000,
    memberPrice: 12000,
    ...
    id: "4",
    name: "Wokha Recreation Club",
    location: "Main Road, Wokha",
    price: 18000,
    memberPrice: 10000,
    image: "https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    isIndoor: false,
    city: "Wokha",
    available: true
  }];
