...
export function PricingSection() {
  ...
  const membershipTiers: MembershipTier[] = [{
    ...
    benefits: ["Unlimited court access during regular hours", "10% discount on equipment purchases", "Access to members-only events", "Online court booking", "Monthly newsletter"],
    isPopular: false
  }, {
    id: "family",
    name: "Family",
    price: billingCycle === "monthly" ? 2000 : 20000,
    benefits: ["Access for up to 4 family members", "Unlimited court access during regular hours", "15% discount on equipment purchases", "Access to members-only events", "Priority court booking", "Monthly newsletter", "Free guest passes (2 per month)"],
    isPopular: true
  }, {
    id: "junior",
    name: "Junior",
    price: billingCycle === "monthly" ? 600 : 6000,
    benefits: ["For players under 18 years", "Unlimited court access during regular hours", "5% discount on equipment purchases", "Access to junior training programs", "Monthly newsletter"],
    isPopular: false
  }, {
    id: "visitor",
    name: "Visitor Pass",
    price: billingCycle === "monthly" ? 2500 : 0,
    benefits: ["30-day access to all facilities", "No long-term commitment", "Access to open play sessions", "Equipment rental included"],
    isPopular: false
  }];
  ...
  return <section className="py-20 bg-background" data-unique-id="73d02262-d6cc-4d35-9543-846bd0c9386f" data-file-name="components/membership/pricing-section.tsx">
      <div className="container mx-auto px-6" data-unique-id="b4c9f826-53a2-41e0-aa2a-5bb4e6f6ac9b" data-file-name="components/membership/pricing-section.tsx" data-dynamic-text="true">
              ...
              duration: 0.3
                  ...
                  <div className="p-6" data-unique-id="84ff2d63-8a99-47af-9ae6-78a5d17d1416" data-file-name="components/membership/pricing-section.tsx" data-dynamic-text="true">
                    ...
                    <div className="mb-6 flex items-baseline" data-unique-id="15421707-94e3-429c-b6ec-bab1ab251d3b" data-file-name="components/membership/pricing-section.tsx" data-dynamic-text="true">
                      <span className="text-4xl font-bold" data-unique-id="9043338d-4d31-44d7-93f3-b4d196b1759f" data-file-name="components/membership/pricing-section.tsx" data-dynamic-text="true"><span className="editable-text" data-unique-id="5c859a52-300e-4c03-9803-9d57dd61dbc4" data-file-name="components/membership/pricing-section.tsx">₹</span>{tier.price / 100}</span>
                      {billingCycle === "monthly" ? <span className="ml-1 text-sm text-foreground/70" data-unique-id="38dc316c-6fff-43c1-93bd-3e00418dfeb8" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="9af7fd36-db31-4ff7-ab8e-b45338e46a13" data-file-name="components/membership/pricing-section.tsx">/month</span></span> : <span className="ml-1 text-sm text-foreground/70" data-unique-id="8dafb642-1ebf-44b6-a5de-401cb6a64d3c" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="ece9282e-4801-486a-b17d-cf976d70b561" data-file-name="components/membership/pricing-section.tsx">/year</span></span>}
                    </div>
                    
                    {tier.id !== "visitor" || billingCycle === "monthly" ? <Button variant={tier.isPopular ? "primary" : "outline"} className="mb-6 w-full" motion data-unique-id="fb67d272-6b92-478c-8486-6d2e9ec1001a" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="d5596a6d-b3ed-489b-b92b-a0fb8e7518a4" data-file-name="components/membership/pricing-section.tsx">
                        Get Started
                      </span></Button> : <div className="mb-6 rounded-md bg-muted p-2 text-center text-sm" data-unique-id="9bb7debb-7c71-47d1-ad1b-7385116782df" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="89a17154-0898-4bb4-adb0-76fc9785fcde" data-file-name="components/membership/pricing-section.tsx">
        ...
        duration: 0.5,
        delay: 0.5
      }} className="mt-16 rounded-lg bg-secondary p-6 text-center" data-unique-id="4e811b6f-715c-436b-a114-9cd1a686f4f0" data-file-name="components/membership/pricing-section.tsx">
          <p className="mb-4 text-lg font-medium" data-unique-id="06734181-736f-4fe0-9319-515cd313948f" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="b5385c15-1001-4a4c-88ef-32da3bb11543" data-file-name="components/membership/pricing-section.tsx">Need a custom membership option?</span></p>
          <p className="mb-6 text-foreground/70" data-unique-id="59349d26-c468-4d25-9951-9e9746454cdd" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="593640c2-3156-43be-957e-f47b85bdaec8" data-file-name="components/membership/pricing-section.tsx">
            Contact us for group rates, corporate memberships, or special arrangements.
          </span></p>
          <Button variant="cta" className="group" data-unique-id="7c651932-7113-4a28-9ab7-c76cdb5d7203" data-file-name="components/membership/pricing-section.tsx"><span className="editable-text" data-unique-id="c5839a5e-f415-47e7-8e7f-73b514fd788a" data-file-name="components/membership/pricing-section.tsx">
            Contact Us
            </span><ChevronRight className="ml-1 h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Button>
        </motion.div>
      </div>
    </section>;
