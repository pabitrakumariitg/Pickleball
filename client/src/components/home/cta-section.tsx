          ...
          <div className="relative px-6 py-16 md:px-12 md:py-20" data-unique-id="373ae19e-2a6f-4938-963d-ab44ec96dd26" data-file-name="components/home/cta-section.tsx">
            <div className="mx-auto max-w-3xl text-center" data-unique-id="5c068bbd-2cfa-43e0-8002-b8dfc2981fb3" data-file-name="components/home/cta-section.tsx">
              ...
              delay: 0.2
                ...
                Ready to Join Nagaland's Pickleball Community?
              </span></motion.h2>
              ...
              delay: 0.3
                ...
                Play your first game, join a tournament, or simply come watch and learn about this exciting sport!
              </span></motion.p>
              ...
              delay: 0.4
                ...
                <Link href="/membership" data-unique-id="ebd2b4a3-acb6-40a8-a3cf-1a2ccb34e54a" data-file-name="components/home/cta-section.tsx">
                  <Button variant="outline" size="lg" className="border-primary-foreground bg-transparent text-primary-foreground hover:bg-primary-foreground/10" motion data-unique-id="8d6ffaf8-1fad-4d9e-b37a-5044bcc9e735" data-file-name="components/home/cta-section.tsx"><span className="editable-text" data-unique-id="59d0fdc7-f343-4c47-b523-3fd3facde99f" data-file-name="components/home/cta-section.tsx">
                    Become a Member
                  </span></Button>
                </Link>
              </motion.div>
