...
export function TeamSection() {
  const teamMembers: TeamMember[] = [{
    ...
    bio: "A passionate pickleball advocate with over a decade of coaching experience.",
    social: {
  ...
  },
  {
    ...
    bio: "Committed to community engagement and youth programs.",
    social: {
      linkedin: "https://linkedin.com"
    }
  },
  {
    name: "Mr. Rajesh Longkumer",
    role: "Treasurer",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    bio: "Ensuring financial transparency and growth.",
    social: {
      linkedin: "https://linkedin.com"
    }
  }];
